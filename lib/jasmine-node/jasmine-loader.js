(function() {
  ...
  boot = require('./jasmine/node_boot.js');
  myjasmine = require('./jasmine/jasmine.js');

  jasminejs = __dirname + '/jasmine/jasmine.js';
  ...
  loadJasmine = function() {
    ...
    //  }
    //};
    //jasmineEnv = booter.boot(getJasmineRequireObj(), clockCallback);
    console.log("about to call node_boot function, I think");
    return boot(myjasmine);
  };
